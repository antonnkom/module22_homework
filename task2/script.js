const buttonChangeIcon = document.querySelector('#changeIcon');
const btnIcon = document.querySelector('.btn-icon');

buttonChangeIcon.addEventListener('click', changeIcon);

function changeIcon ()
{
    if (! buttonChangeIcon.classList.contains('btn-change-icon')) {
        btnIcon.innerHTML = `
    ...
    buttonChangeIcon.classList.toggle('btn-change-icon');
}